		...
		<div style="display:table-row">
			<div style="display:table-cell; width:50%">
				<table class="prumoFormTable">
					<tr>
						...
						<td class="prumoFormFields"><b><?php echo _('CONFIGURAÇÕES DA APLICAÇÃO'); ?></b></td>
					</tr>
					<tr>
						<td class="prumoFormLabel">appIdent:</td>
						<td class="prumoFormFields"><input id="appIdent" type="text" value="<?php echo $GLOBALS['pConfig']['appIdent'] ?>" size="30" /></td>
					</tr>
					<tr>
						<td class="prumoFormLabel">appName:</td>
						<td class="prumoFormFields"><input id="appName" type="text" value="<?php echo $GLOBALS['pConfig']['appName'] ?>" size="30" /></td>
					</tr>
					<tr>
						<td><br /></td>
						<td><br /></td>
					...
					<tr>
						<td class="prumoFormLabel"><br /></td>
						<td class="prumoFormFields"><b><?php echo _('BANCO DE DADOS DA APLICAÇÃO'); ?></b></td>
					</tr>
					<?php if (isset($GLOBALS['pConfig']['dbSingle']) and $GLOBALS['pConfig']['dbSingle']) { ?>
					<tr>
						<td class="prumoFormLabel"><br /></td>
						<td class=""><?php echo _('Modo "dbSingle" ativado, configurações de conectividade disponível em prumo.php'); ?></td>
					</tr>
					<?php } ?>
					<tr>
					...
					<tr>
						...
						<td class="prumoFormFields"><input id="dbHost" type="text" value="<?php echo $GLOBALS['pConfig']['dbHost'] ?>" size="30" <?php if (isset($GLOBALS['pConfig']['dbSingle']) and $GLOBALS['pConfig']['dbSingle']) echo ' disabled="disabled" ' ?>/></td>
					</tr>
					<tr>
						<td class="prumoFormLabel">dbPort:</td>
						<td class="prumoFormFields"><input id="dbPort" type="text" value="<?php echo $GLOBALS['pConfig']['dbPort'] ?>" size="30" <?php if (isset($GLOBALS['pConfig']['dbSingle']) and $GLOBALS['pConfig']['dbSingle']) echo ' disabled="disabled" ' ?>/></td>
					</tr>
					<tr>
						<td class="prumoFormLabel">dbName:</td>
						<td class="prumoFormFields"><input id="dbName" type="text" value="<?php echo $GLOBALS['pConfig']['dbName'] ?>" size="30" <?php if (isset($GLOBALS['pConfig']['dbSingle']) and $GLOBALS['pConfig']['dbSingle']) echo ' disabled="disabled" ' ?>/></td>
					</tr>
					<tr>
						<td class="prumoFormLabel">dbUserName:</td>
						<td class="prumoFormFields"><input id="dbUserName" type="text" value="<?php echo $GLOBALS['pConfig']['dbUserName'] ?>" size="30" <?php if (isset($GLOBALS['pConfig']['dbSingle']) and $GLOBALS['pConfig']['dbSingle']) echo ' disabled="disabled" ' ?>/></td>
					</tr>
					<tr>
						<td class="prumoFormLabel">dbPassword:</td>
						<td class="prumoFormFields"><input id="dbPassword" type="password" value="<?php echo $GLOBALS['pConfig']['dbPassword'] ?>" size="30" <?php if (isset($GLOBALS['pConfig']['dbSingle']) and $GLOBALS['pConfig']['dbSingle']) echo ' disabled="disabled" ' ?>/></td>
					</tr>
					<tr>
						<td class="prumoFormLabel">appSchema:</td>
						<td class="prumoFormFields"><input id="appSchema" type="text" value="<?php echo $GLOBALS['pConfig']['appSchema'] ?>" size="30" /></td>
					</tr>
				</table>
			...
			<div style="display:table-cell">
				...
				<table class="prumoFormTable">
					<tr>
						<td class="prumoFormLabel"><br /></td>
						<td class="prumoFormFields"><br /><b><?php echo _('CONFIGURAÇÕES DO FRAMEWORK'); ?></b></td>
					</tr>
					<tr>
						<td class="prumoFormLabel">theme:</td>
						<td class="prumoFormFields">
							<?php echo $inputTheme; echo ' <a href="https://github.com/prumo/themes" target="_blank">'._('Mais temas').'...</a>' ?> 
						</td>
					</tr>
					<tr>
						<td class="prumoFormLabel">searchLines:</td>
						<td class="prumoFormFields"><input id="searchLines" type="number" value="<?php echo $GLOBALS['pConfig']['searchLines'] ?>" size="5" /></td>
					</tr>
					<tr>
						<td class="prumoFormLabel"><br /></td>
						<td class="prumoFormFields">
					...
					<tr>
						...
						<td class="prumoFormFields"><input id="scriptUpdateFramework" type="text" value="<?php echo $GLOBALS['pConfig']['scriptUpdateFramework'] ?>" size="30" /></td>
					</tr>
					<tr>
						<td class="prumoFormLabel">scriptUpdateApp:</td>
						<td class="prumoFormFields"><input id="scriptUpdateApp" type="text" value="<?php echo $GLOBALS['pConfig']['scriptUpdateApp'] ?>" size="30" /></td>
					</tr>
					<tr>
						<td class="prumoFormLabel"><br /></td>
						<td class="prumoFormLabel"><br /></td>
...
<script type="text/javascript">
	...
	pAjaxControlPanel = new prumoAjax('<?php echo $GLOBALS['pConfig']['prumoWebPath']; ?>/ctrl_control_panel.php');
