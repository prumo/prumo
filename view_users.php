...
<div id="crudUsers_form">
	...
	<table class="prumoFormTable">
		...
		<tr>
			<td class="prumoFormLabel"><?php echo _('Nome completo'); ?>:</td>
	...
	<legend><?php echo _('Grupos do usuário'); ?></legend>
		...
		<table align="center" width="600">
			<tr>
				<td align="center">
					<br />
					<button class="pButton" id="bt_write" onclick="btWrite_click()"><?php echo _('Gravar'); ?></button>
					<button class="pButton" id="bt_copy_from" onclick="searchUsers.goSearch();"><?php echo _('Copiar de'); ?></button>
					<button class="pButton warning" id="bt_cancel" onclick="refreshLists()"><?php echo _('Cancelar'); ?></button>
				</td>
			</tr>
		</table>
		
		<br />
		<?php echo _('OBS: CTRL + Clique para selecionar mais de um'); ?>
	</fieldset>
	<br />
