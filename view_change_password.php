...
<script>
	...
	pAjaxChangePassword = new prumoAjax('<?php echo $GLOBALS['pConfig']['prumoWebPath']; ?>/ctrl_change_password.php');
...
<legend><?php echo _('Alterar Senha'); ?></legend>
	...
	<table class="prumoFormTable">
		<tr>
			<td class="prumoFormLabel"><?php echo _('Usuário'); ?>:</td>
			<td class="prumoFormFields"><input id="username" type="text" size="30" value="<?php echo $prumoGlobal['currentUser'] ?>" disabled="disabled" /></td>
		</tr>
		<tr>
			<td class="prumoFormLabel"><?php echo _('Senha Atual'); ?>:</td>
			<td class="prumoFormFields"><input id="password" type="password" size="30" autofocus="autofocus" />*</td>
		</tr>
		<tr>
			<td class="prumoFormLabel"><?php echo _('Nova Senha'); ?>:</td>
			<td class="prumoFormFields"><input id="new_password" type="password" size="30" />*</td>
		</tr>
		<tr>
			<td class="prumoFormLabel"><?php echo _('Repita a nova senha'); ?>:</td>
			<td class="prumoFormFields"><input id="new_password_confirm" type="password" size="30" />*</td>
		</tr>
		<tr>
			<td class="prumoFormLabel"></td>
			<td class="prumoFormFields"><button class="pButton" onclick="goChangePassword()"><?php echo _('Alterar Senha'); ?></button></td>
		</tr>
	</table>
	<br />
